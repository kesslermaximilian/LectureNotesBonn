...
\newcommand{\lecture}[3][]{
    ...
    \marginpar{\small\textsf{\parbox{10em}{Vorlesung \thelecture \\#2}}}
    \addcontentsline{lec}{lecture}{Vorlesung \thelecture{}(#2)}
    \ifthenelse{\isempty{#1}}{}{\addtocontents{lec}{\smallskip\hspace{1.5em}\protect #1}}
}
