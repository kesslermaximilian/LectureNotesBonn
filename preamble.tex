...
\newcommand\listlecturename{Liste der Vorlesungen}
\newlistof{mylecture}{lec}{\listlecturename}
...
\def\@lecture{\ifenglish Lecture\else Vorlesung\fi\, #1: #3}%
    ...
    \addcontentsline{lec}{mylecture}{\protect\numberline{\themylecture}\@lecture \\ das ist ein test}
}
