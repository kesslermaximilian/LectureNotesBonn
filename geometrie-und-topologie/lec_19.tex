%! TEX root = ./master.tex
\lecture[Decktransformationen von $\exp\colon\R -> S^1$. Normalisatoren. Gruppenisomorphismus $\Delta(p)\cong H \backslash N_{pi1(X,x0)}H$ zwischen Decktransformationen und ~Fundamentalgruppe. Gruppenwirkungen. Semidirekte Produkte und die Fundamentalgruppe des Torus $\Z \rtimes \Z$.]{Di 29 Jun 2021 12:14}{Decktransformationen}
\begin{example}
    \begin{enumerate}[1)]
