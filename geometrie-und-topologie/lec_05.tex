\lecture{5}{Di 27 Apr 2021 12:16}{Basen, Subbasen}
...
\begin{proof}
    ...
    \end{tikzcd}
    \end{figure}
    Wir sehen leicht, dass $\overline{f}$ bijektiv ist. Da $D^n$ kompakt, ist auch  $D^n / \sim $ kompakt, und $\R\mathbb{P}^n$ ist Hausdorffsch, also handelt es sich um einen Homöomorphismus (mit \autoref{cor:compact-to-hausdorff-is-homeomorphism})
\end{proof}
