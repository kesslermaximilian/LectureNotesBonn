...
\begin{remark*}
    Die Aussage des Satzes ist so zu verstehen, dass die beiden Gruppen $p_*(\pi_1(E,e_0))$ und $p_*(\pi_1(E,e_0'))$ als \textit{Untergruppen} von $\pi_1(X,x_0)$ gleich sind, nicht, dass sie isomorph sind.

    Vergleiche hierzu dann auch \autoref{ex:zusammenhängende-überlagerungen-der-s1}. 
\end{remark*}
