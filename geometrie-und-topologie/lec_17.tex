...
\begin{theorem}\label{thm:charakteristische-untergruppen-innerhalb-der-faser-sind-nur-konjugiert-wenn-weg-zwischen-urbildern-existiert}
    ...
    \[
        p_*(\pi_1(E,e_0)) = [p \circ  w] \star \pi_1(E,e_0') \star [p \circ  \overline{w}]
    .\] 
\end{theorem}
...
\begin{proof}[Beweis vom Satz]
    Wir wissen, dass die Abbildung
        \begin{equation*}
        \begin{array}{c c l} 
            \pi_1(E,e_0') & \longrightarrow & \pi(E,e_0) \\
            \left[v\right] & \longmapsto &  \left[w \star v \star \overline{w}\right]
        \end{array}
    \end{equation*}
    ein Isomorphismus ist. Es ist 
    \[
        p_*[w \star v \star \overline{w}] = [p \circ  (w \star v \star \overline{w})] = [ p \circ  w] \star [p \circ  v] \star [p \circ  \overline{w}]
    .\] 
und damit ist
\[
    p_*(\pi_1(E,e_0)) = [p \circ  w] \star \pi_1(E,e_0') \star [p \circ  \overline{w}]
...
\begin{remark*}
Leider musste ich heute die Vorlesung vorzeitig verlassen, deswegen endet die Mitschrift (erstmal) hier. Wird aber nachgetragen.
\end{remark*}
