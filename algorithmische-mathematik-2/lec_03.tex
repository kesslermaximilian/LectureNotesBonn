\lecture{3}{Mo 19 Apr 2021 10:23}{Gleichverteilung, empirische Verteilung}
...
.\] 
, die \vocab{empirische Häufigkeit} von $A$.  $\mathbb{P}$ ist die \vocab{empirische Verteilung}.  
\[
    p(\omega) = \frac{N(\left \{\omega\right\} )}{n}
.\] 
ist die \vocab{relative Häufigkeit} von $\omega\in \Omega$.
